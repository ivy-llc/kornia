...
<div class="flex-container"><!-- .element:  style="display: flex; flex-direction: row; justify-content: center; align-items: center;" -->
<div>Multi-framework support with </div><div><img class="only-dark" style="width: 100px; height: 40px;" width="100" height="40" src="https://raw.githubusercontent.com/unifyai/unifyai.github.io/main/img/externally_linked/logo_dark.png#gh-dark-mode-only"/><img class="only-light" style="width: 100px; height: 40px;" width="100" height="40" src="https://raw.githubusercontent.com/unifyai/unifyai.github.io/main/img/externally_linked/logo.png?raw=true#gh-light-mode-only"/></div>
</div>
